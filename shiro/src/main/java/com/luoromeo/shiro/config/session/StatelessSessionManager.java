package com.luoromeo.shiro.config.session;
 ...
 * 由于app和小程序没有session，SecurityUtils.getSubject()是根据session来判断的，因此需要自定义自己的sessinManager
 *
 * 使用时在ShiroConfiguration里securityManager.setSessionManager(new StatelessSessionManager());
 * @author zhanghua.luo
 * @date 2018年08月17日 15:21
 * @modified By
 */
@Slf4j
